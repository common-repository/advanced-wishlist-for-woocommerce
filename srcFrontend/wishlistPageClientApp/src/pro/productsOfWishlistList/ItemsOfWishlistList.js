...
import QuantityInput from 'BaseComponents/productsOfWishlistList/QuantityInput'
...
const ItemsOfWishlistList = (props) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            mobileProperties: {},
            renderCell: (row) => <QuantityInput wishlistId={wishlistId} row={row} lockInterfaceCallback={lockInterfaceUntilPromiseIsDone}/>,
            visible: showColumns.qty,
        },
        {
            id: 'stockStatus',
    ...
    return (
        ...
        >
            <Box>
                ...
                {rows.length > 0 &&
                    <BulkActions bulkActions={bulkActions} onBulkActionApply={onBulkActionApply}/>
                }
